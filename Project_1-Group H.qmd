...
# Step 2 - Covert into long format
  pivot_longer(cols=3:12,
               names_to = "enrollment",
               values_to = "number") |>
# Step 3 - pull out the year and convert the year into a numeric value
...
```{r}
# create function to extract year and measurements
process_data_step_4_5_6 <- function(step_3_output){
  
  # create county data
  county_matching <- grep(pattern = ", \\w\\w", step_3_output$area_name) 
  county <- step_3_output[county_matching,]
  return(county)
  # create non-county data
  non_county <- step_3_output[-county_matching,]
  return(non_county)
...
>>>>>>> db46a65e537d303a5cf469468e9525a124716662
## Writing a Generic Function for Summarizing
